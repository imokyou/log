...
type Lager struct {
	...
	RollingDisable bool   `yaml:"rollingDisable"`
...
func Initialize(writers, loggerLevel, loggerFile string, rollingDisable bool, rollingPolicy string, logFormatText bool,
